...
hi Method          guifg=#87af00 ctermfg=106 gui=none

"syn match PTR1 '\v\.\zs\w*\ze[:.,)[:space:][\\]'
...
if v:version >= 508 || !exists('did_python_syn_inits')
    ...
    HiLink pythonFunctionCall     Structure
    ...
    HiLink pythonClassVar         Define

    HiLink pythonDot              SpecialChar
    HiLink pythonBrackets         Special
    HiLink PTR1                   Error
